...
-->
 ...
 <img alt="disque optique" src="/opac-tmpl/prog/famfamfam/silk/cd.png" title="disque optique" class="format" />
 </xsl:if>
 ...
 available online
 <img alt="distant" src="/opac-tmpl/prog/famfamfam/silk/drive_web.png" title="distant" class="format" />
 </xsl:if>
 ...
 <img alt="Globe céleste" src="/opac-tmpl/prog/famfamfam/silk/world.png" title="Globe céleste" class="format" />
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='d'][substring(text(),2,1)='e']">
 <img alt="Globe lunaire/terrestre" src="/opac-tmpl/prog/famfamfam/silk/world.png" title="Globe lunaire/terrestre" class="format" />
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='d'][substring(text(),2,1)='b']">
 <img alt="globe planétaire ou lunaire" src="/opac-tmpl/prog/famfamfam/silk/world.png" title="globe planétaire ou lunaire" class="format" />
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='d'][substring(text(),2,1)='c']">
 <img alt="globe terrestre" src="/opac-tmpl/prog/famfamfam/silk/world.png" title="globe terrestre" class="format" />
 </xsl:if>
 ...
 <img alt="graphique" src="/opac-tmpl/prog/famfamfam/silk/chart_curve.png" title="graphique" class="format" />
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='c']">
 collage
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='d']">
 <img alt="dessin" src="/opac-tmpl/prog/famfamfam/silk/pencil.png" title="dessin" class="format" />
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='o']">
 <img alt="carte flash" src="/opac-tmpl/prog/famfamfam/silk/note.png" title="carte flash" class="format" />
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='e']">
 <img alt="peinture" src="/opac-tmpl/prog/famfamfam/silk/paintbrush.png" title="peinture" class="format" />
 </xsl:if>
 ...
 <img alt="image" src="/opac-tmpl/prog/famfamfam/silk/picture.png" title="image" class="format" />
 </xsl:if>
 ...
 <img alt="musique annotée" src="/opac-tmpl/prog/famfamfam/silk/script.png" title="musique annotée" class="format" />
 </xsl:if>
 ...
 <img alt="diapositive" src="/opac-tmpl/prog/famfamfam/silk/pictures.png" title="diapositive" class="format" />
 </xsl:if>
 ...
 <img alt="disque son" src="/opac-tmpl/prog/famfamfam/silk/cd.png" title="disque son" class="format" />
 </xsl:if>
 ...
 <img alt="gros caractères" src="/opac-tmpl/prog/famfamfam/silk/magnifier.png" title="gros caractères" class="format" />
 </xsl:if>
 ...
 <img alt="vidéo disque" src="/opac-tmpl/prog/famfamfam/silk/dvd.png" title="vidéo disque" class="format" />
 </xsl:if>
...
<xsl:if test="$DisplayOPACiconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img alt="livre" src="/opac-tmpl/prog/famfamfam/silk/book_link.png" title="livre" class="materialtype" /> Set</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'"><img alt="livre" src="/opac-tmpl/prog/famfamfam/silk/book.png" title="livre" class="materialtype" />Livre</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'"><img alt="périodique" src="/opac-tmpl/prog/famfamfam/silk/newspaper.png" title="périodique" class="materialtype" />Ressource continue</xsl:when>
 ...
 <xsl:when test="$leader6='t'"><img alt="livre" src="/opac-tmpl/prog/famfamfam/silk/book.png" title="livre" class="materialtype" />Livre</xsl:when>
 ...
 <xsl:when test="$leader6='p'"><img alt="mélange" src="/opac-tmpl/prog/famfamfam/silk/report_disk.png" title="mélange" class="materialtype" />Matériel mixte</xsl:when>
 <xsl:when test="$leader6='m'"><img alt="Fichier informatique" src="/opac-tmpl/prog/famfamfam/silk/computer_link.png" title="Fichier informatique" class="materialtype" />Fichier informatique</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'"><img alt="carte" src="/opac-tmpl/prog/famfamfam/silk/map.png" title="carte" class="materialtype" />Carte</xsl:when>
 <xsl:when test="$leader6='g' or $leader6='k' or $leader6='r'"><img alt="matériel visuel" src="/opac-tmpl/prog/famfamfam/silk/film.png" title="matériel visuel" class="materialtype" /> </xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'"><img alt="partition" src="/opac-tmpl/prog/famfamfam/silk/music.png" title="partition" class="materialtype" />Partition</xsl:when>
 <xsl:when test="$leader6='i'"><img alt="son" src="/opac-tmpl/prog/famfamfam/silk/sound.png" title="son" class="materialtype" />Son</xsl:when>
 <xsl:when test="$leader6='j'"><img alt="musique" src="/opac-tmpl/prog/famfamfam/silk/sound.png" title="musique" class="materialtype" />Musique</xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <img alt="base de données" src="/opac-tmpl/prog/famfamfam/silk/database.png" title="base de données" class="format" />
 </xsl:when>
 ...
 <img alt="Site web" src="/opac-tmpl/prog/famfamfam/silk/world_link.png" title="Site web" class="format" />
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 bibliography
 <img alt="bibliographie" src="/opac-tmpl/prog/famfamfam/silk/text_list_bullets.png" title="bibliographie" class="natureofcontents" />
 </xsl:when>
 ...
 <img alt="rapport technique" src="/opac-tmpl/prog/famfamfam/silk/report.png" title="rapport technique" class="natureofcontents" />
 </xsl:when>
 ...
 <img alt="fonte" src="/opac-tmpl/prog/famfamfam/silk/font.png" title="fonte" class="format" /> 
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <img alt="jeu" src="/opac-tmpl/prog/famfamfam/silk/controller.png" title="jeu" class="format" />
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <img alt="Biographie" src="/opac-tmpl/prog/famfamfam/silk/user.png" title="Biographie" class="natureofcontents" />
 </xsl:if>
