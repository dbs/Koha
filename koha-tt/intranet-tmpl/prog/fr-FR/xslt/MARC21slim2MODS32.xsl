...
-->
 ...
 <xsl:attribute name="collection">Oui</xsl:attribute>
 </xsl:if>
 <xsl:if test="$leader6='d' or $leader6='f' or $leader6='p' or $leader6='t'">
 <xsl:attribute name="manuscript">Oui</xsl:attribute>
 </xsl:if>
 <xsl:choose>
 ...
 <genre authority="marc">périodique</genre>
 </xsl:when>
 ...
 <genre authority="marc">encyclopédie</genre>
 </xsl:when>
 ...
 <genre authority="marc">discographie</genre>
 </xsl:when>
 ...
 <genre authority="marc">Texte programmé</genre>
 </xsl:when>
 ...
 <genre authority="marc">brevet</genre>
 </xsl:if>
 ...
 <genre authority="marc">pièce de théatre</genre>
 </xsl:when>
 ...
 <genre authority="marc">poésie</genre>
 </xsl:if>
 ...
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">reproduction d'art</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 ...
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">image</genre>
 </xsl:when>
 ...
 <form authority="marcform">imprimé</form>
 </xsl:when>
 <xsl:when test="$leader6 = 'm' or ($check008-23 and $controlField008-23='s') or ($check008-29 and $controlField008-29='s')">
 <form authority="marcform">électronique</form>
 </xsl:when>
 ...
 <reformattingQuality>préservation</reformattingQuality>
 </xsl:when>
 ...
 <form authority="smd">globe terrestre ou lunaire</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='d'][substring(text(),2,1)='b']">
 <form authority="smd">globe planétaire ou lunaire</form>
 </xsl:if>
 ...
 <form authority="smd">profil</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='r']">
 ...
 <form authority="smd">carte à fenêtre</form>
 </xsl:if>
 ...
 <form authority="smd">dessin</form>
 </xsl:if>
 ...
 <form authority="smd">reproduction photomécanique</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='g']">
 <form authority="smd">négatif photo</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='h']">
 <form authority="smd">tirage photographique</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='i']">
 <form authority="smd">image</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='j']">
 <form authority="smd">imprimé</form>
 </xsl:if>
 ...
 <targetAudience authority="marctarget">Préscolaire</targetAudience>
 </xsl:when>
